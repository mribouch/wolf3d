...
/*   Updated: 2019/07/04 11:21:25 by mribouch         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_init_wolf(t_window *infos)
{
	...
	infos->wolf.dir_cam.x = cos(infos->wolf.angle_cam) * 5 + infos->wolf.pos_cam.x;
	infos->wolf.dir_cam.y = sin(infos->wolf.angle_cam) * 5 + infos->wolf.pos_cam.y;
